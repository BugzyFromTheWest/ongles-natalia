...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-white/45 text-[9px] tracking-widest uppercase">Mobile Nail Studio</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Link href="/book" className="bg-white/15 hover:bg-white/25 backdrop-blur border border-white/25 text-white text-sm font-semibold px-4 py-2 rounded-xl transition-all">
      ...
      {/* ── FEATURED SERVICES ─────────────────────────────────────────── */}
      <section className="relative px-6 py-16 sm:py-20 z-[2]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[10px] text-white/70 font-semibold tracking-[0.25em] uppercase mb-2">
      ...
      {/* ── CONTACT + HOURS ───────────────────────────────────────────── */}
      <section className="relative px-6 py-16 overflow-hidden z-[2]">
            ...
            <div className="rounded-2xl p-6 space-y-4" style={{ background: "rgba(255,255,255,0.15)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.25)" }}>
              ...
              {business?.instagram && (
                <a href={business.instagram} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-3 text-sm transition-colors text-white/80 hover:text-white">
                  <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0 text-white" style={{ background: "rgba(244,197,106,0.2)", border: "1px solid rgba(244,197,106,0.45)" }}>
            ...
            <div className="rounded-2xl p-6" style={{ background: "rgba(255,255,255,0.15)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.25)" }}>
              ...
              <div className="space-y-2">
                {[1, 2, 3, 4, 5, 6, 0].map((day) => {
                  ...
                  return (
                    <div key={day} className="flex justify-between items-center text-sm py-1.5 border-b last:border-0"
                      style={{
                        borderColor: "rgba(255,255,255,0.15)",
                        fontWeight: today === day ? 700 : 400,
                        color: today === day ? "#f4c56a" : "rgba(255,255,255,0.8)",
                      }}
                    >
                      <span>{lang === "fr" ? DAY_FULL_FR[day] : DAY_FULL_EN[day]}</span>
                      <span style={{ opacity: isClosed ? 0.4 : 1 }}>
      ...
      <footer className="relative z-[2] bg-sidebar text-white/50 px-6 py-8 text-center text-xs space-y-1">
        ...
        <p className="pt-2 text-white/25">© {currentYear} Ongles Natalia. {lang === "fr" ? "Tous droits réservés." : "All rights reserved."}</p>
